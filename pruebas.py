...
def generar_respuesta(mensaje, numero_usuario):
    ...
    # Paso 2: Esperando Fecha
        ...
        try:
            ...
            if fecha >= datetime.now():
                ...
                del reservas[numero_usuario]['esperando_fecha']
    ...
    # Paso 3: Esperando Hora con validación de horario
        ...
        if re.match(r'^(?:[01]\d|2[0-3]):[0-5]\d$', mensaje):
            hora_reserva = mensaje
            if HORARIO_APERTURA <= hora_reserva <= HORARIO_CIERRE:
                reservas[numero_usuario]['hora'] = hora_reserva
                reservas[numero_usuario]['esperando_nombre'] = True
                del reservas[numero_usuario]['esperando_hora']
